...
import com.example.homefoodfighter_android.databinding.FragmentFusionBinding


class FusionFragment : Fragment() {
    private lateinit var viewBinding : FragmentFusionBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentFusionBinding.inflate(layoutInflater)
