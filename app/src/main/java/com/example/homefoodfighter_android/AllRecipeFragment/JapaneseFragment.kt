...
import com.example.homefoodfighter_android.databinding.FragmentJapaneseBinding

class JapaneseFragment : Fragment() {
    private lateinit var viewBinding : FragmentJapaneseBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentJapaneseBinding.inflate(layoutInflater)
