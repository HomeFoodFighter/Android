...
import com.example.homefoodfighter_android.databinding.FragmentChineseBinding


class ChineseFragment : Fragment() {
    private lateinit var viewBinding : FragmentChineseBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentChineseBinding.inflate(layoutInflater)
