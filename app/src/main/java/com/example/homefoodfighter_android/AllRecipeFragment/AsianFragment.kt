...
import com.example.homefoodfighter_android.databinding.FragmentAsianBinding


class AsianFragment : Fragment() {
    private lateinit var viewBinding : FragmentAsianBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentAsianBinding.inflate(layoutInflater)
