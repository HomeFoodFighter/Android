...
import com.example.homefoodfighter_android.databinding.FragmentWesternBinding


class WesternFragment : Fragment() {
    private lateinit var viewBinding : FragmentWesternBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentWesternBinding.inflate(layoutInflater)
